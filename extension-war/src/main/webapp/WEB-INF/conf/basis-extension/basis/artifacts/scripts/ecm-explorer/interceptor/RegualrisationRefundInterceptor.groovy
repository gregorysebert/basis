...
public class RegualrisationRefundInterceptor implements CmsScript {
    ...
    /** NAME_PREFIX*/
    private static final String NAME_PREFIX = "REFUND";

    private RepositoryService repositoryService_;

    Node currentNode;

    public RegualrisationRefundInterceptor(RepositoryService repositoryService) {
    ...
    public void execute(Object context) {
        ...
        try {
            ...
            if (currentNode.getName().equals("refund_temp")) {
                ...
                while (ni.hasNext()) {
                    ...
                    if (current.getPrimaryNodeType().getName().equals("spff:rulingReguRefund")) {
                        String nodeName = current.getName();
                        if (Integer.parseInt(nodeName.substring(19, 21)) > payNum) {
                            payNum = Integer.parseInt(nodeName.substring(19, 21));
                        }
                    }
                }
                String strNum = "";
                ...
                String newPath = this.REGULARISATION_PATH + "/" + folderName + "/Payments/" + folderName + "-" + NAME_PREFIX + "-" + strNum;
