...
SelectItemCategory GNYPageConfigs = new SelectItemCategory("BasisPageConfigs") ;
categories.add(GNYPageConfigs);
GNYPageConfigs.addSelectItemOption(new SelectItemOption("BASIS layout", "BASIS layout", "BASISLayout"));
